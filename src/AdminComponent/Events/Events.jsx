...
const Events = () => {
  ...
  const handleDateChange = (date, dateType) => {
    ...
    if (date) {
      // Use dayjs to format the date as a string
      const formattedDate = dayjs(date).format("YYYY-MM-DDTHH:mm:ss");
      // Update formValues with the formatted date
                    ...
                    <DateTimePicker
                      renderInput={(props) => (
                        <TextField
                          ...
                          value={formValues.startedAt || ""}
                          onChange={(e) =>
                            handleDateChange(e.target.value, "startedAt")
                          }
                        />
                      )}
                      className="w-full"
                    ...
                    <DateTimePicker
                      renderInput={(props) => (
                        <TextField
                          ...
                          value={formValues.endsAt || ""}
                          onChange={(e) =>
                            handleDateChange(e.target.value, "endsAt")
                          }
                        />
                      )}
                      className="w-full"
